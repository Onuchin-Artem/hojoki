...
#pagebreak(to: "odd")
#v(1fr)
#align(center, text(font: sans, size: 13pt, fill: grey)[Камо но Чьомей])
#v(2fr)
...
#block(width: 100%, height: 100%)[
  ...
  #text(size: 6.5pt, fill: grey)[Камо но Чьомей] \
...
#prose[
  ...
  Ходжьокі\u{00A0}— Думки у ретрітній хатинці\u{00A0}— це поема, яку написав Камо но Чьомей у тринадцятому столітті в Японії. Проте вона відчувається дуже актуальною і сучасною, особливо для українців. Відчуття кінця світу, яке так багато людей проживають зараз,\u{00A0}— воно було саме таким#linebreak(justify: true)
  і за життя автора.
...
#pagebreak(to: "odd")
#v(1fr)
#align(center, text(font: sans, size: 12pt, fill: grey)[Камо но Чьомей])
#v(1.5fr)
...
#page(fill: photo-bg, margin: 0pt, header: none, footer: none)[
  #block(width: 100%, height: 100%, inset: (left: 26mm + bleed, right: 14mm + bleed, y: 24mm + bleed))[
    ...
    #v(1.4em)
    На фотографії зображена ретрітна хатинка в буддійському центрі Garchen Buddhist Institute серед пагорбів Арізони. У таких хатинках сучасні йогіни роблять трирічні ретріти, у яких вони усамітнюються і присвячують себе практиці. Розмір такої хатинки\u{00A0}— три на три метри, саме як ходжьо, ретрітна хатинка самого#linebreak(justify: true)
    Камо но Чьомея.
